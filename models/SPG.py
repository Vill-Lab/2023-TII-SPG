...
from utils.utils import gcn_norm, edge_index_to_sparse_tensor_adj
...
class SPG(nn.Module):
    def __init__(self, cfg, data, edge_relation, num_features, num_hidden, num_classes, dropout, layer_num=2, device='cuda'):
    ...
    def forward(self, images, targets=None, query_img_as_gallery=False):
        ...
        losses["loss_gcn"] *= F.log_softmax(h, 1)
